  ...
  Future<bool> _ensureNfcReady() async {
    ...
    final openSettings = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text('Aero-Sense needs NFC enabled to read the physical tag UID. NFC is a device setting, so Android must enable it before scanning.'),
        actions: [
    ...
    try {
      ...
      if (mounted) {
        setState(() => error = 'Unable to open NFC settings. Please enable NFC manually in Android Settings.');
      }
    }
    return false;
  }
          ...
          child: Column(children: [
            ...
            if (uid != null) ...[
              ...
              Container(
                ...
                child: Row(children: [const Icon(Icons.tag_outlined, size: 18, color: muted), const SizedBox(width: 9), Expanded(child: Text(uid!, style: const TextStyle(fontWeight: FontWeight.w800, letterSpacing: 1.0)))]),
              ),
            ],
          ]),
        ),
