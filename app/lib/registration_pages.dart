...
class _RegisterComponentState extends State<RegisterComponentScreen> {
  ...
  @override Widget build(BuildContext context) => Scaffold(backgroundColor: bg, appBar: AppBar(title: const Text('Register Component'), backgroundColor: bg), body: ListView(padding: const EdgeInsets.fromLTRB(20, 18, 20, 100), children: [
    ...
    CardBox(child: Column(children: [TextField(controller: serial, decoration: const InputDecoration(labelText: 'Serial Number *')), const SizedBox(height: 12), TextField(controller: type, decoration: const InputDecoration(labelText: 'Component Type *')), const SizedBox(height: 12), TextField(controller: manufacturer, decoration: const InputDecoration(labelText: 'Manufacturer *')), const SizedBox(height: 12),
...
class _RegisterTagState extends State<RegisterTagScreen> {
  ...
  @override Widget build(BuildContext context) => Scaffold(backgroundColor: bg, appBar: AppBar(title: const Text('Register NFC Tag'), backgroundColor: bg), body: ListView(padding: const EdgeInsets.fromLTRB(20, 18, 20, 100), children: [
    ...
    CardBox(child: Column(children: [
      ...
      Row(children: [Expanded(child: OutlinedButton.icon(onPressed: scanning ? null : readNfc, icon: const Icon(Icons.nfc), label: Text(scanning ? 'Reading…' : 'Read NFC'))), const SizedBox(width: 10), Expanded(child: FilledButton.icon(onPressed: saving ? null : save, icon: const Icon(Icons.link), label: Text(saving ? 'Saving…' : 'Bind Tag'))]),
    ])),
  ]));
}
