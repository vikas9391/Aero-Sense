...
class _RegisterComponentState extends State<RegisterComponentScreen> {
  ...
  void _msg(String text, [bool error = false]) => ScaffoldMessenger.of(context).showSnackBar(
      ...
      await NfcManager.instance.startSession(
        ...
        onDiscovered: (tag) async {
          try {
            ...
            if (mounted) {
              setState(() => identifier.text = t.id.map((b) => b.toRadixString(16).padLeft(2, '0')).join(':').toUpperCase());
            }
          } catch (e) {
            if (mounted) _msg(api.errorMessage(e), true);
          } finally {
