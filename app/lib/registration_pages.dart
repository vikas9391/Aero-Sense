...
class _RegisterTagState extends State<RegisterTagScreen> {
            ...
            children: [
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final bind = FilledButton.icon(onPressed: saving || scanning ? null : save, icon: const Icon(Icons.link), label: Text(saving ? 'Binding…' : 'Bind tag to component'));
                  if (compact) return Column(children: [SizedBox(width: double.infinity, child: read), const SizedBox(height: 8), SizedBox(width: double.infinity, child: bind)]);
  ...
  Widget _bindingRow(String label, String value) => Padding(
    ...
    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      SizedBox(width: 100, child: Text(label, style: const TextStyle(color: muted))),
