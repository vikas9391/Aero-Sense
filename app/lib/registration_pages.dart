          ...
          children: [
            ...
            CardBox(child: Column(children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(labelText: 'Identifier *', hintText: '04:AB:12:...', suffixIcon: IconButton(onPressed: scanning ? null : readNfc, icon: Icon(scanning ? Icons.sync : Icons.nfc))),
              ),
              const SizedBox(height: 12),
              DropdownButtonFormField<String>(
                isExpanded: true,
              ...
              LayoutBuilder(builder: (context, constraints) {
                ...
                return compact
                    ? Column(children: [SizedBox(width: double.infinity, child: read), const SizedBox(height: 10), SizedBox(width: double.infinity, child: bind)])
                    : Row(children: [Expanded(child: read), const SizedBox(width: 10), Expanded(child: bind)]);
              }),
            ])),
          ],
        ),
