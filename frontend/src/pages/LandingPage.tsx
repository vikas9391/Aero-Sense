  ...
  return (
    <div className="min-h-screen bg-[#f7fafb] font-body text-ink">
      ...
      <div className="px-3 pb-3 pt-3 md:px-5 md:pb-5 md:pt-5">
        <div className="mx-auto max-w-[1680px] overflow-hidden rounded-[28px] border border-white/80 bg-white shadow-[0_30px_90px_-30px_rgba(7,18,24,.18)] md:rounded-[34px]">
          <main>
            <ProblemSection />
            <SolutionFeature />
            <DigitalTwinSection />
